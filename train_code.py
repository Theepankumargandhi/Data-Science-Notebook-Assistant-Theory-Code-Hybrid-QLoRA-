...
# Paths / config
# -------------------
BASE = "mistralai/Mistral-7B-Instruct-v0.2"   # if gating bites again, try: "HuggingFaceH4/zephyr-7b-beta"
DATA_FILE = "data/train.jsonl"                # your single JSONL file
OUT_DIR   = "output"
MAX_LEN   = 1024
EPOCHS    = 2
BATCH_SZ  = 1
...
# Expects each line like: {"messages":[{"role":"system","content":"..."}, {"role":"user","content":"..."}, {"role":"assistant","content":"..."}]}
# -------------------
...
def to_prompt(example):
    # Build chat prompt via model-native template
...
# Prefer 'evaluation_strategy'; if Trainer in your env expects 'eval_strategy', switch
