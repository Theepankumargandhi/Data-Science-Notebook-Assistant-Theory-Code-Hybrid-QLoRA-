...
OUT_DIR = "output_theory"                      # separate folder for theory adapter
DVC_MODEL_DIR = "models/theory_adapter"
MAX_LEN = 1024
EPOCHS = 2
BATCH_SZ = 1
GRAD_ACC = 16
...
# Version tracking
VERSION = "v1.0"
EXPERIMENT_NAME = f"theory_adapter_{VERSION}_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
...
with mlflow.start_run(run_name=EXPERIMENT_NAME):
    ...
    print(f"✅ Theory adapter training completed successfully!")